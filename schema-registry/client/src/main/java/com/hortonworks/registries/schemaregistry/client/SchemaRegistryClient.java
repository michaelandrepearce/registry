...
public class SchemaRegistryClient implements ISchemaRegistryClient {
    ...
    public SchemaRegistryClient(Map<String, ?> conf) {
        ...
        schemaVersionInfoCache = new SchemaVersionInfoCache(
                ...
                Integer.valueOf(configuration.getValue(Configuration.SCHEMA_VERSION_CACHE_SIZE.name())),
                Long.valueOf(configuration.getValue(Configuration.SCHEMA_VERSION_CACHE_EXPIRY_INTERVAL_SECS.name())) * 1000L
        );
